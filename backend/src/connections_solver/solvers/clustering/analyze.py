...
def analyze(
    ...
    Args:
        ...
        true_categories: Optional ground truth categories for analysis

    Returns:
        Recommended algorithm name: 'kmeans', 'agglomerative', or 'dbscan'
    """
    print("\n" + "=" * 60)
    ...
    if true_categories and separation_ratio < 1.2:
...
if __name__ == "__main__":
    ...
    if puzzle:
        ...
        # Run analysis
        recommended_algorithm = analyze(embeddings, puzzle.words, categories)
